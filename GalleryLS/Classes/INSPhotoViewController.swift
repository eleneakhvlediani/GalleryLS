...
open class INSPhotoViewController: UIViewController, UIScrollViewDelegate {
   ...
   // lazy var playerController:AVPlayerViewController = AVPlayerViewController()
    
//    lazy var playerController:AVPlayerViewController = {
//
//        var pl = AVPlayerViewController()
//        
//        pl.view.frame = UIScreen.main.bounds
//        
//        return pl
//       
//    }()
    ...
    public init(photo: INSPhotoViewable, playerLayer:AVPlayerLayer?) {
    ...
    open override func viewDidLoad() {
        ...
        scalingImageView.backgroundColor = .clear
        ...
        if(photo.isVideo == 1){
            ...
            if(playerLayer == nil){
             ...
             videoView?.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(INSPhotoViewController.videoTapAction)))
    ...
    @objc private func videoTapAction(){
        ...
        if(playerLayer?.player?.isPlaying == true){
            ...
            if playerLayer == nil {
                ...
                self.playerLayer = AVPlayerLayer(player: photo.video)
